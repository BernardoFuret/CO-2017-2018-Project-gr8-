// $Id: type_checker.h,v 1.2 2018/05/10 23:46:16 ist180844 Exp $ -*- c++ -*-
...
namespace gr8 {
  ...
  protected:
    ...
    void processBinaryExpression_and_or(cdk::binary_expression_node * const node, int lvl);
    void processBinaryExpression_mul_div(cdk::binary_expression_node * const node, int lvl);
    void processBinaryExpression_lt_gt(cdk::binary_expression_node * const node, int lvl);
    template<typename T>
